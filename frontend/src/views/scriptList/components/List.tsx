    ...
    },
    {
      ...
      render(value, record, index) {
        return (
          <div>
            <Space>
              <Edit reflash={reflash} modal={modal} messageApi={messageApi} type='edit' data={record}></Edit>
              <Config
                modal={modal}
                ...
                reflash={reflash}
              ></Config>
              <Detail modal={modal} messageApi={messageApi} drwerHeight={drwerHeight} data={record}></Detail>
            </Space>
          </div>
        )
      }
